                        ...
                        case 0:
                            ...
                            while (fieldBitsToProcess != 0 && f < wdbVars.FieldCount)
                            {
                                ...
                                switch (fieldType)
                                {
                                    ...
                                    case "s":
                                        sTypeDataVal = (uint)strArrayDataDict[wdbVars.Fields[f]].IndexOf(recordData.Value[f].ToString());
                                        ...
                                        Console.WriteLine($"{wdbVars.Fields[f]}: {sTypeDataVal}");
