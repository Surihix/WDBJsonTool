        ...
        public static readonly Dictionary<string, List<string>> FieldNames = new()
        {
            ...
            { "ItemWeapon",
                new List<string>()
                {
                    ...
                    "u8UnkVal2", "u2UnkVal3", "u7MaxLvl", "u4UnkVal4", "u1IsLightningUse", "u1IsSazzUse", "u1IsSnowUse",
                    "i10ExpRate1", "i10ExpRate2", "i10ExpRate3", "u1IsVaniraUse", "u1IsHopeUse", "u8StatusModKind0",
                    "u8StatusModKind1", "u4StatusModType", "u1IsFangUse", "u1UnkBool1", "u16UnkVal5",
